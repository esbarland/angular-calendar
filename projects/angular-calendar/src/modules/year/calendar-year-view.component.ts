...
export interface CalendarYearViewBeforeRenderEvent extends WeekView {
  header: WeekDay[];
}
  ...
  implements OnChanges, OnInit, OnDestroy, AfterViewInit
{
  ...
  @Output() beforeViewRender =
    new EventEmitter<CalendarYearViewBeforeRenderEvent>();
   ...
   * @hidden
   */
  calendarId = Symbol('angular calendar year view id');
